...
mod 'theforeman/puppet', :git => 'https://github.com/theforeman/puppet-puppet', :ref => '14.0.0'
...
mod 'voxpupuli/extlib',  :git => 'https://github.com/voxpupuli/puppet-extlib',          :ref => 'v2.0.1-82-g53c6e2b'
