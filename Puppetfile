...
mod 'theforeman/puppet', :git => 'https://github.com/theforeman/puppet-puppet', :ref => '15.1.0'
mod 'theforeman/tftp',   :git => 'https://github.com/theforeman/puppet-tftp',   :ref => '7.0.0'

mod 'systemd',           :git => 'https://github.com/camptocamp/puppet-systemd',        :ref => '3.0.0'
mod 'voxpupuli/extlib',  :git => 'https://github.com/voxpupuli/puppet-extlib',          :ref => 'v5.3.0'
mod 'redis',             :git => 'https://github.com/voxpupuli/puppet-redis',           :ref => 'v7.0.0'
